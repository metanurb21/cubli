...
class BleCallbacks : public BLECharacteristicCallbacks
{
    void onWrite(BLECharacteristic *bleCharacteristic) override
    {
        ...
        // String rx_Value = pBiDirectionalCharacteristic->getValue(); // Use String instead of std::string
...
void Esp32ble::begin(const std::string &a)
{ // Use String as parameter type
    BLEDevice::init(a);
...
void Esp32ble::write(const std::string &x)
{ // Use String as parameter type
    if (isDeviceConnected)
    {
